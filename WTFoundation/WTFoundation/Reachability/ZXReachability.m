...
#pragma unused (target, flags)
	...
	NSCAssert([(__bridge NSObject*) info isKindOfClass: [ZXReachability class]], @"info was wrong class in ReachabilityCallback");

    ZXReachability* noteObject = (__bridge ZXReachability *)info;
...
{
	ZXReachability* returnValue = NULL;
